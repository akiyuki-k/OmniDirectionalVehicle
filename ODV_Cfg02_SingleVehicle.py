# =====================================================================================================
#  ODV(Omni-directiobal Vehicle) Configuration 02: 3×2 Base Grid, with GBC loader and unloader 
# =====================================================================================================
...
vc.move(  0, 10) # Move to the initial position
vc.wait_ms(1000)
...
while True:
    ...
    # Uncomment the following 2 lines to add the circle movement demo
    #vc.move( 10, 10)
    #vc.move_circ(5,"CCW",720,-180)