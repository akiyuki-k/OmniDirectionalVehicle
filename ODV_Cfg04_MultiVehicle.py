# =====================================================================================================
#  ODV(Omni-directiobal Vehicle) Configuration 04: 4×2 Base Grid, with GBC loader and unloader and Two vehicles 
# =====================================================================================================
...
VEHICLE_COUNT                   :int = 2        # Total number of vehicles (N)
USE_SINGLE_SENDER_VEHICLE       :bool = True    # True: one sender and rest are receivers, False: all are receivers
SENDER_VEHICLE_ID               :int = 2        # ID (1 to N) of the vehicle used as the sender when USE_SINGLE_SENDER_VEHICLE is True
...
while True:
    ...
    # Uncomment the following 6 lines to add the circle movement demo
    #mvc.move( 10,  0, 20,  0)
    #mvc.wait_sync_ms(200)
    #mvc.move_circ(5,"CW",360,180,180)
    #mvc.wait_sync_ms(200)
    #mvc.move( 10,  0, 20, 10)
    #mvc.wait_sync_ms(200)
